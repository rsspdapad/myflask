...
@app.callback(
    Output('wat-dropdown', 'children'),
    Input('wat-dropdown', 'value')
)
def update_autocomplete_off_wat(value):
    return html.Script("""
        setTimeout(function(){
            let element = document.querySelector("#wat-dropdown .Select-input > input");
            if(element) {
...
@app.callback(
    Output('wat2-dropdown', 'children'),
    Input('wat2-dropdown', 'value')
)
def update_autocomplete_off_wat2(value):
    return html.Script("""
        setTimeout(function(){
            let element = document.querySelector("#wat2-dropdown .Select-input > input");
            if(element) {
                element.setAttribute('autocomplete', 'off');
            }
        }, 0);
...
@app.callback(
    Output('rad-dropdown', 'children'),
    Input('rad-dropdown', 'value')
)
def update_autocomplete_off_rad(value):
    return html.Script("""
        setTimeout(function(){
            let element = document.querySelector("#rad-dropdown .Select-input > input");
            if(element) {
                element.setAttribute('autocomplete', 'off');
            }
        }, 0);
...
@app.callback(
    Output('mag-dropdown', 'children'),
    Input('mag-dropdown', 'value')
)
def update_autocomplete_off_mag(value):
    return html.Script("""
        setTimeout(function(){
            let element = document.querySelector("#mag-dropdown .Select-input > input");
            if(element) {
                element.setAttribute('autocomplete', 'off');
            }
        }, 0);
